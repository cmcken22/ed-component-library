...
`),m.rippleVisible,ct,ne,({theme:e})=>e.transitions.easing.easeInOut,m.ripplePulsate,({theme:e})=>e.transitions.duration.shorter,m.child,m.childLeaving,pt,ne,({theme:e})=>e.transitions.easing.easeInOut,m.childPulsate,ft,({theme:e})=>e.transitions.easing.easeInOut),mt=a.forwardRef(function(t,r){const l=Re({props:t,name:"MuiTouchRipple"}),{center:n=!1,classes:i={},className:o}=l,c=ie(l,lt),[u,p]=a.useState([]),d=a.useRef(0),g=a.useRef(null);a.useEffect(()=>{g.current&&(g.current(),g.current=null)},[u]);const b=a.useRef(!1),C=Ae(),h=a.useRef(null),R=a.useRef(null),U=a.useCallback(f=>{const{pulsate:y,rippleX:M,rippleY:D,rippleSize:j,cb:K}=f;p(T=>[...T,N.jsx(ht,{classes:{ripple:x(i.ripple,m.ripple),rippleVisible:x(i.rippleVisible,m.rippleVisible),ripplePulsate:x(i.ripplePulsate,m.ripplePulsate),child:x(i.child,m.child),childLeaving:x(i.childLeaving,m.childLeaving),childPulsate:x(i.childPulsate,m.childPulsate)},timeout:ne,pulsate:y,rippleX:M,rippleY:D,rippleSize:j},d.current)]),d.current+=1,g.current=K},[i]),$=a.useCallback((f={},y={},M=()=>{})=>{const{pulsate:D=!1,center:j=n||y.pulsate,fakeElement:K=!1}=y;if((f==null?void 0:f.type)==="mousedown"&&b.current){b.current=!1;return}(f==null?void 0:f.type)==="touchstart"&&(b.current=!0);const T=K?null:R.current,P=T?T.getBoundingClientRect():{width:0,height:0,left:0,top:0};let v,w,L;if(j||f===void 0||f.clientX===0&&f.clientY===0||!f.clientX&&!f.touches)v=Math.round(P.width/2),w=Math.round(P.height/2);else{const{clientX:F,clientY:V}=f.touches&&f.touches.length>0?f.touches[0]:f;v=Math.round(F-P.left),w=Math.round(V-P.top)}if(j)L=Math.sqrt((2*P.width**2+P.height**2)/3),L%2===0&&(L+=1);else{const F=Math.max(Math.abs((T?T.clientWidth:0)-v),v)*2+2,V=Math.max(Math.abs((T?T.clientHeight:0)-w),w)*2+2;L=Math.sqrt(F**2+V**2)}f!=null&&f.touches?h.current===null&&(h.current=()=>{U({pulsate:D,rippleX:v,rippleY:w,rippleSize:L,cb:M})},C.start(ut,()=>{h.current&&(h.current(),h.current=null)})):U({pulsate:D,rippleX:v,rippleY:w,rippleSize:L,cb:M})},[n,U,C]),_=a.useCallback(()=>{$({},{pulsate:!0})},[$]),I=a.useCallback((f,y)=>{if(C.clear(),(f==null?void 0:f.type)==="touchend"&&h.current){h.current(),h.current=null,C.start(0,()=>{I(f,y)});return}h.current=null,p(M=>M.length>0?M.slice(1):M),g.current=y},[C]);return a.useImperativeHandle(r,()=>({pulsate:_,start:$,stop:I}),[_,$,I]),N.jsx(dt,A({className:x(m.root,i.root,o),ref:R},c,{children:N.jsx(st,{component:null,exit:!0,children:u})}))}),bt=mt;function gt(e){return Ke("MuiButtonBase",e)}const Rt=ye("MuiButtonBase",["root","disabled","focusVisible"]),yt=["action","centerRipple","children","className","component","disabled","disableRipple","disableTouchRipple","focusRipple","focusVisibleClassName","LinkComponent","onBlur","onClick","onContextMenu","onDragLeave","onFocus","onFocusVisible","onKeyDown","onKeyUp","onMouseDown","onMouseLeave","onMouseUp","onTouchEnd","onTouchMove","onTouchStart","tabIndex","TouchRippleProps","touchRippleRef","type"],Mt=e=>{const{disabled:t,focusVisible:r,focusVisibleClassName:l,classes:n}=e,o=Oe({root:["root",t&&"disabled",r&&"focusVisible"]},gt,n);return r&&l&&(o.root+=` ${l}`),o},Tt=oe("button",{name:"MuiButtonBase",slot:"Root",overridesResolver:(e,t)=>t.root})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${Rt.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),Et=a.forwardRef(function(t,r){const l=Re({props:t,name:"MuiButtonBase"}),{action:n,centerRipple:i=!1,children:o,className:c,component:u="button",disabled:p=!1,disableRipple:d=!1,disableTouchRipple:g=!1,focusRipple:b=!1,LinkComponent:C="a",onBlur:h,onClick:R,onContextMenu:U,onDragLeave:$,onFocus:_,onFocusVisible:I,onKeyDown:f,onKeyUp:y,onMouseDown:M,onMouseLeave:D,onMouseUp:j,onTouchEnd:K,onTouchMove:T,onTouchStart:P,tabIndex:v=0,TouchRippleProps:w,touchRippleRef:L,type:F}=l,V=ie(l,yt),O=a.useRef(null),E=a.useRef(null),Me=de(E,L),{isFocusVisibleRef:le,onFocus:Te,onBlur:Ee,ref:xe}=et(),[k,X]=a.useState(!1);p&&k&&X(!1),a.useImperativeHandle(n,()=>({focusVisible:()=>{X(!0),O.current.focus()}}),[]);const[J,Ce]=a.useState(!1);a.useEffect(()=>{Ce(!0)},[]);const ve=J&&!d&&!p;a.useEffect(()=>{k&&b&&!d&&J&&E.current.pulsate()},[d,b,k,J]);function B(s,ce,_e=g){return H(pe=>(ce&&ce(pe),!_e&&E.current&&E.current[s](pe),!0))}const Ve=B("start",M),Be=B("stop",U),Pe=B("stop",$),we=B("stop",j),Le=B("stop",s=>{k&&s.preventDefault(),D&&D(s)}),De=B("start",P),Fe=B("stop",K),ke=B("stop",T),Se=B("stop",s=>{Ee(s),le.current===!1&&X(!1),h&&h(s)},!1),Ne=H(s=>{O.current||(O.current=s.currentTarget),Te(s),le.current===!0&&(X(!0),I&&I(s)),_&&_(s)}),Q=()=>{const s=O.current;return u&&u!=="button"&&!(s.tagName==="A"&&s.href)},Z=a.useRef(!1),$e=H(s=>{b&&!Z.current&&k&&E.current&&s.key===" "&&(Z.current=!0,E.current.stop(s,()=>{E.current.start(s)})),s.target===s.currentTarget&&Q()&&s.key===" "&&s.preventDefault(),f&&f(s),s.target===s.currentTarget&&Q()&&s.key==="Enter"&&!p&&(s.preventDefault(),R&&R(s))}),Ie=H(s=>{b&&s.key===" "&&E.current&&k&&!s.defaultPrevented&&(Z.current=!1,E.current.stop(s,()=>{E.current.pulsate(s)})),y&&y(s),R&&s.target===s.currentTarget&&Q()&&s.key===" "&&!s.defaultPrevented&&R(s)});let W=u;W==="button"&&(V.href||V.to)&&(W=C);const z={};W==="button"?(z.type=F===void 0?"button":F,z.disabled=p):(!V.href&&!V.to&&(z.role="button"),p&&(z["aria-disabled"]=p));const je=de(r,xe,O),ue=A({},l,{centerRipple:i,component:u,disabled:p,disableRipple:d,disableTouchRipple:g,focusRipple:b,tabIndex:v,focusVisible:k}),Ue=Mt(ue);return N.jsxs(Tt,A({as:W,className:x(Ue.root,c),ownerState:ue,onBlur:Se,onClick:R,onContextMenu:Be,onFocus:Ne,onKeyDown:$e,onKeyUp:Ie,onMouseDown:Ve,onMouseLeave:Le,onMouseUp:we,onDragLeave:Pe,onTouchEnd:Fe,onTouchMove:ke,onTouchStart:De,ref:je,tabIndex:p?-1:v,type:F},z,V,{children:[o,ve?N.jsx(bt,A({ref:Me,center:i},w)):null]}))}),Dt=Et;export{Dt as B};
